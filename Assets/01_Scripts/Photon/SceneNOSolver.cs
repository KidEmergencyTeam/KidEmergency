...
public class SceneNOSolver : NetworkSceneManagerDefault
{
    private Dictionary<NetworkObjectTypeId, NetworkObject> _sceneObjects;

    public bool TryResolveSceneObject(NetworkRunner runner, NetworkObjectTypeId sceneObjectGuid, out NetworkObject instance)
    {
